...
class ProjectIssue(models.Model):
    ...
    user_id = fields.Many2one('res.users', string='Assigned to', index=True, tracking=True, default=lambda self: self.env.uid)
    ...
    @api.returns('project.issue', lambda value: value.id)
